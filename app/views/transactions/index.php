    ...
    <div class="box">
        <form id="addForm" class="form-inline text-center">
            <div class="form-group">
                <label for="merchant" class="sr-only">Merchant</label>
                <input type="text" class="form-control input-sm" id="merchant" name="merchant" placeholder="Description (Shop Tesco)" required autofocus>
            </div>
  
            <div class="form-group">
                <label for="created" class="sr-only">Created</label>
                <input type="text" class="form-control input-sm" id="created" name="created" placeholder="Date (2015-02-23)" required>
            </div>
            
            <div class="form-group">
                <label for="amount" class="sr-only">Amount</label>
                <input type="text" class="form-control input-sm" id="amount" name="amount" placeholder="Amount (230)" required>
            </div>
